/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7188e4e6003ba5f5fa10694ce1cf89b0)
...
interface __BaseEnv_Env {
	...
	APP_URL: "https://hackalem.abzal.dev" | "http://localhost:3000";
	VECTOR_SEARCH_ENABLED: "true" | "false";
}
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		DB: D1Database;
		VECTORIZE: VectorizeIndex;
		APP_URL: "https://hackalem.abzal.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "VECTOR_SEARCH_ENABLED">> {}
}
